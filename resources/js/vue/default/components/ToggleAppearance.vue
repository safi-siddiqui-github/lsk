<script setup lang="ts">
    ...
    import { useAppearance } from '@/vue/composables/useAppearance';
...
<template>
    <button
        ...
        :class="
            cn(
                'flex w-12 cursor-pointer items-center gap-1 rounded-full border border-black dark:border-white px-1 py-0.5',
                {
